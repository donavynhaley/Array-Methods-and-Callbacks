...
// This if statement sees who scored more goals and returns the winner
...
function getCountryWins(data, teamInitials) {
    ...
    const numOfWins = allFinals.reduce((total, goals, index) => {
        if(goals["Home Team Initials"] == teamInitials && goals["Home Team Goals"] > goals["Away Team Goals"]){
            total++;
        }
        else if(goals["Away Team Initials"] == teamInitials && goals["Away Team Goals"] > goals["Home Team Goals"]){
            total++;
        }
        return total;
    }, 0);
